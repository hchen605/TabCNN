...
#from keras.utils import np_utils #HH
#from keras import utils as np_utils #HH
from tensorflow.keras.utils import * #HH

class DataGenerator(keras.utils.all_utils.Sequence): #HH
